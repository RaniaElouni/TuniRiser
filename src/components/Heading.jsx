...
export default function Heading({tit1,tit2,withLottie}) {
  return (
    <div className={`flex mx-4 z-50 ${tit1 === "MEDIA SERVICES" ? "ml-8":"" }  flex-col md:flex-row justify-between items-center ${tit1 !== "ABOUT US" ? "mb-12 ":"" }xl:mb-12 `}>
          <h2
          ...
          <h2
            className={`opacity-20 z-50  ${tit1==="OUR TEAM" ? "mx-12":""} text-[1.4rem] leading-[32.5px]  lg:text-4xl xl:text-5xl`}
            style={{
              fontFamily: "AgainstRegular",
